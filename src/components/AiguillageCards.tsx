    ...
    <section id="services" className="py-24 md:py-32 relative scroll-mt-8">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Link
            href="/clubs"
            className="group relative bg-bg-card border border-white/5 rounded-xl p-7 md:p-8 hover:border-cyan-accent/30 transition-all overflow-hidden flex flex-col"
          >
