...
export default function MiniAboutAthletes() {
  return (
        ...
        <div className="bg-bg-card border border-white/5 rounded-xl p-8 md:p-10 flex flex-col md:flex-row items-start gap-6">
          ...
          <div>
            ...
            <p className="text-text-secondary leading-relaxed">
              Coureur de fond (1h17 au semi-marathon, 2h54 au marathon), diplômé
              en STAPS et titulaire d&apos;un Master en Nutrition du Sport.
              Athlète et scientifique, je parle le même langage que vous.
            </p>
            <Link
              href="/about"
